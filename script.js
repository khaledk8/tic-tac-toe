...
const svgO = `<svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--noto" preserveAspectRatio="xMidYMid meet" fill="#000000">
...
function winCondition (player = activePlayer) {
    ...
    if (Gameboard.gameboard[0][2] == Gameboard.gameboard[1][1] && Gameboard.gameboard[0][2] == Gameboard.gameboard[2][0] && Gameboard.gameboard[0][2] != 0) {
        winner(0,2)
    }
}

function winner (x, y, player = activePlayer) {
